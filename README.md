# Melissa - National ZIP+4 Downloader

This is the script that downloads National ZIP+4 for you to use.

For the latest Melissa National ZIP+4 release notes, please visit: 
- https://releasenotes.melissa.com/reference-data/national-zip4/


## Tested Environments
- Windows 11 64-bit .NET Runtimes 7.0, Powershell 5.1
- Ubuntu Linux 22.04.3 LTS 64-bit .NET 7.0
- Melissa National ZIP+4 for 2023-10
...
```
$ git clone https://github.com/MelissaData/NationalZIP4-Downloader
$ cd NationalZIP4-Downloader
```
...
You will need to set your license before running the `NationalZIP4_Downloader.ps1`. 
...
You will need to set your license before running the `NationalZIP4_Downloader.sh`. 
